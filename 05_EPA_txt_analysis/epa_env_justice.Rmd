---
title: "Topic 5: Word Relationships with EPA Env Justice"
...
word_pairs %>%
  ...
  ggraph(layout = "fr") +
  geom_edge_link(aes(edge_alpha = n, edge_width = n), edge_colour = "firebrick4") +
...
Now let's look at the 'tf-idf' (term-frequency - individual-document-frequency) term we talked about. Remember, this statistic goes beyond simple frequency calculations within a document to control for overall commonality across documents

```{r}
# tf - unique words throughout all documents
# tf-idf - unique words specific to an individual document
...
# Calculate basic frequency stat from dfm
# Outputs most frequent words for all documents
...
```{r convert_dfm}
# single word is "n-gram" or "unigram"
...
```{r}
# back to "n-gram"
# keyness creates a matrix that compares the reference  compare what words 
# given a particular document, it compares
...
To date have been looking at independent units of words. Frequency of words. Sentiment of individual words.

Here we'll look at how other words relate to the text