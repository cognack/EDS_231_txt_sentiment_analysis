...
# words within a 10-word window of "water"
...
# words outside a 10-word window of "water"
...
gt_keyness2 <- gt(keyness2[1:20])
gt_keyness2 %>% 
  tab_header(title = "Top 20 Word Associations with 'water'")
```
