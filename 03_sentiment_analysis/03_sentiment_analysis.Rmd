...
# blue is raw score, only seen when it brings the score below
# red is total score
# including the offset allows you get the sentiment of a particular page, relative to the rest of the book
...
# Intro to Nexus uni data source
